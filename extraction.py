...
# Essayer d'ouvrir et de lire le fichier "DumpFile.txt"
try:
...
with open("Oumar.csv", "w", newline='', encoding="utf8") as fic:
    writer = csv.writer(fic, delimiter=';')  # Utiliser le point-virgule comme délimiteur
    writer.writerow(["Heure", "Source", "Port", "Destination", "Flag", "Seq", "Ack", "Win", "Options", "Length"])  # En-tête du fichier CSV

    # Parcourir chaque ligne du fichier
    for event in ress:
        if event.startswith('11:42'):  # Filtrer les événements qui commencent par "11:42"
